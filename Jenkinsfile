  ...
  stages {
      stage('Build Artifact') {
            steps {
              ...
              archive 'target/*.jar' //so that they can sdddddsdssssdbddde downssssloassssded laterssssdddhjhjaaasdsdsadasssffffsssssdsdsdsssssssssdddd   dddeee   sasssddd ddd hhhhddsds hhh
            }
        }
         stage('unit test') {
                    steps {
